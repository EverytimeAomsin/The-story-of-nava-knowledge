...
#วาดตอนกดเปิดมือถือ
    ...
    Player          "ผม[Player]ครับ เป็นเด็กมหาลัยคนหนึ่งที่ได้รับการให้ทำการทดสอบการคัดเลือกเข้าทำงานของที่นี่"
...
#วาด / รูปหน้าบริษัท
    ...
    menu:
                ...
                "โทรศัพท์จากเบอร์เขาให้มา":
                        Player "พี่ครับ ผมจะไปเจอพี่ที่ไหนครับ"
...
#รูปเดอะโกรฟ
    scene matchroom4
    Fah             "เมื่อเดินกลับมาจะเจอศูนย์อาหาร ที่นี่มีชื่อว่าเดอะโกรฟ ที่นี่จะขายอาหารนานาชาติ เช่น \nเวสเทิร์นคอร์เนอร์-มุมอาหารตะวันตก \nช้อปสติ๊กส์-มุมอาหารจีน \nนู้ดเดิ้ลบาร์-มุมอาหารเส้น \nไทยไรซ์” มุมอาหารไทย \nและ ซีฟู๊ดกริลล์-มุมอาหารซีฟู๊ด"
    Fah             "ที่นี่สามารถจ่ายได้ผ่าน RFID จากริสแบนด์"

#รูปล็อกเกอร์
    scene matchroom5
    Fah             "เมื่อเดินออกจากเดอะโกรฟมาจะเจอชั้นใต้ดินจะเจอตู้ล็อกเกอร์ ที่นี่สามารถเปิดได้ด้วย RFID"
...
#รูปแผนกนวด
    scene matchroom9
    Fah             "เมื่อออกจากบริเวณ ช้างเชริพโซน จะเห็นร้านนวดแผนของวานา นาวา ข้างๆใต้สไลค์เดอร์บูมเบอร์แรงโก้" 
    Player          "บูมเมอร์แรงโก้คืออะไร?"
    Fah             "บูมเมอร์แรงโก้คือเครื่องเล่นสีเหลือง"
...
#รูปฟิชเชอร์แมนส์คาเฟ่
    scene matchroom14
    Fah             "เมื่อข้ามสะพานมาจะเจอร้านอาหารชื่อว่าฟิชเชอร์แมนส์คาเฟ่จะให้บริการอาหารและของว่างที่ทานสะดวกและรวดเร็ว"
...
#รูปอควาลูป
    ...
    Player          "อ้อๆเปล่าเลยๆ สบายดีๆ มีอะไรหรอกครับ"
    Player          "เอ๊ะ เบลเหรอ"
    ...
    Player          "คือว่าพวกเราเรียนที่เดียวกันตอนมัธยมต้นและปลายกันครับ"
    Fah             "บังเอิญจังนะ"
    "ผมได้มองหน้าเบล"
...
#ตัวละครกาย
        ...
        Yuri            "การทดสอบรอบที่ 2 จะมีคะแนนทั้งหมด 100 คะแนน"
        Yuri            "กติกาก็คือผู้เข้าแข่งขันจะต้องเอาแผ่นป้ายออก แล้วทายว่าสถานที่ในภาพคือที่ใด"
        Yuri            "หากตอบถูกจะได้คะแนนเต็ม 25 คะแนน แต่ถ้าหากผู้เข้าแข่งขันไม่แน่ใจในคำตอบ สามารถ เปิดเพิ่มได้ครั้งละ 1 ช่อง แต่คะแนนจะลดลงครั้งละ 5 คะแนน หากตอบถูกจะได้คะแนนในขณะนั้น แต่ถ้าหากตอบผิดจะได้ 0 คะแนน"
        Yuri            "เอาละคะ เราจะเริ่มการทดสอบเลยนะคะ ตอนนี้ทุกทีมจะมีคะแนน 25 คะแนนทุกข้อ อยู่ที่ว่าทีมไหนจะรักษาคะแนนนี้มากที่สุดขอให้โชคดี"
